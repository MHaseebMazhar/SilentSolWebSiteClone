      ...
      <div className="footer-footer">
        <div className="footer-footer1">
          ...
          <div className="footer-logo-div">
            <a href="https://web.facebook.com/silentsoltech/?_rdc=1&amp;_rdr">
              <svg
            ...
            <a href="https://www.instagram.com/silent_sol/?hl=en">
              <svg
                class="footer-logo"
                viewBox="0 0 448 512"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://twitter.com/SilentSol1">
              <svg
                class="footer-logo"
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.linkedin.com/company/silentsol?originalSubdomain=pk">
              <svg
                class="footer-logo"
                viewBox="0 0 448 512"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="footer-footer4">
          <div className="footer-footer4-div"></div>
        </div>
